...
** $Revision: 1.2 $
** $Log: PkgPurchase.c,v $
** Revision 1.2  2013/06/18 07:32:59  fengw
**
** 1、修改应答报文中清算日期域处理代码。
**
...
** 修改日志：
****************************************************************/
int PurchasePack(MsgRule *ptMsgRule, T_App *ptApp, ISO_data *ptData)
{
    char    szTmpBuf[512+1];
    int     iIndex;
...
** 修改日志：
****************************************************************/
int PurchaseUnpack(MsgRule *ptMsgRule, T_App *ptApp, ISO_data *ptData)
{
	char    szTmpBuf[512+1];
	...
	strcpy(ptApp->szSettleDate+4, szTmpBuf);
